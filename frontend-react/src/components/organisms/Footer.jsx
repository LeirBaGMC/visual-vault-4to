                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 border-b border-slate-800/80 pb-20">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-xl text-slate-400 font-sans max-w-lg">
                            Únete a la bóveda y mantén tus referencias, arquitecturas y diseños UI centralizados en un solo lugar.
                        </p>
                    </div>
                    <Link 
                        to="/register" 
                ...
                <div className="flex flex-col md:flex-row justify-between gap-16">
                    ...
                    <div className="flex gap-16 md:gap-24">
                        <div className="flex flex-col gap-5">
                            ...
                            <Link to="/" className="text-sm text-slate-400 hover:text-white transition-colors">Características</Link>
                            <Link to="/" className="text-sm text-slate-400 hover:text-white transition-colors">Integraciones AWS</Link>
                            <Link to="/" className="text-sm text-slate-400 hover:text-white transition-colors">Planes</Link>
                        </div>
                        <div className="flex flex-col gap-5">
                            <h4 className="text-white font-bold text-xs tracking-[0.2em] uppercase">Empresa</h4>
                            <Link to="/about" className="text-sm text-slate-400 hover:text-white transition-colors">Nosotros</Link>
                            <Link to="/policies" className="text-sm text-slate-400 hover:text-white transition-colors">Privacidad</Link>
                            <Link to="/policies" className="text-sm text-slate-400 hover:text-white transition-colors">Términos</Link>
                        </div>
                    </div>
                </div>
